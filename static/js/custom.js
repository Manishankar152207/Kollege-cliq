        ...
        $.ajax({
            ...
            if (response.message == "required"){
                ...
                if(response.college_id){
                    ...
                    var url = p+'/myaccount/'+response.college_id;
                    console.log(url);
...
function toggleAchievement() {
    $('#achievement-show').toggle(500);

}

function changeToggleIcon(){
    if ($( "#toggle-icon" ).hasClass( "fa-plus" )){
        $( "#toggle-icon" ).removeClass( "fa-plus" );
        $( "#toggle-icon" ).addClass( "fa-cut" );
    } else if($( "#toggle-icon" ).hasClass( "fa-cut" )){
        $( "#toggle-icon" ).removeClass( "fa-cut" );
